...
module aksResources 'aks-resources.bicep' = {
  name: 'aksResources-${uniqueString(split(aksResourceId, '/')[8])}'
  scope: resourceGroup(split(aksResourceId, '/')[2], split(aksResourceId, '/')[4])
  params: {
...
resource nodeRecordingRulesRuleGroup 'Microsoft.AlertsManagement/prometheusRuleGroups@2021-07-22-preview' = {
  name: 'NodeRecordingRulesRuleGroup-${split(aksResourceId, '/')[8]}'
  location: location
  properties: {
...
resource kubernetesRecordingRulesRuleGroup 'Microsoft.AlertsManagement/prometheusRuleGroups@2021-07-22-preview' = {
  name: 'KubernetesRecordingRulesRuleGroup-${split(aksResourceId, '/')[8]}'
  location: location
  properties: {
